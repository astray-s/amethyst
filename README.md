...
Amethyst is a noncommercial, open-source clone of Opal that I built as a
portfolio project. It is not affiliated with or endorsed by Opal.
...
<p align="center">
  <img src="docs/screenshots/home.png" width="360" alt="Amethyst Home screen on Android">
</p>
...
2. Download `amethyst-v0.1.2.apk` and its `.sha256` checksum.
...
Amethyst `v0.1.2` is a public beta for personal sideloading. The web and Android
